    ...
    <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-50 via-emerald-50/30 to-blue-50/20">
      ...
      <div className="container mx-auto px-4 py-12 md:py-20 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="relative z-10 w-full h-[300px] md:h-[450px] lg:h-[550px] bg-slate-100 rounded-[30px] md:rounded-[60px] border border-slate-200/60 overflow-hidden shadow-xl flex items-center justify-center">
              <img 
                src="/img/medi13.jpg" 
            ...
            <motion.div 
              ...
              className="absolute top-5 -left-2 md:top-10 md:-left-10 z-20 bg-white/95 backdrop-blur-md p-3 md:p-5 rounded-[20px] md:rounded-[32px] border border-slate-100 shadow-xl"
            >
              <p className="text-emerald-600 font-black text-[8px] md:text-[10px] uppercase mb-1">Flash Sale</p>
              <h4 className="text-slate-800 font-black text-[10px] md:text-base">20% Off Vitamins</h4>
            </motion.div>

            <motion.div 
              animate={{ y: [0, 10, 0] }} 
              transition={{ repeat: Infinity, duration: 4, delay: 1 }} 
              className="absolute bottom-5 -right-2 md:bottom-10 md:-right-5 z-20 bg-emerald-600 p-3 md:p-6 rounded-[20px] md:rounded-[32px] shadow-lg shadow-emerald-600/20"
            >
              <div className="flex items-center gap-2 md:gap-3">
                <FiTruck className="text-white" size={18} />
                <div>
                  <p className="text-emerald-100 text-[8px] md:text-[10px] font-bold uppercase">Free Delivery</p>
                  <p className="text-white font-black text-[10px] md:text-base">Orders 500৳+</p>
                </div>
              </div>
            </motion.div>
          </motion.div>
